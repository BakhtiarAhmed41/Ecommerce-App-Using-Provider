...
final List<Product> products = [
  Product(
    ...
    image: "assets/images/wireless_headphones.jpeg",
    price: 120,
    seller: "John",
    colors: [
      Colors.black,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/smart_watch.jpeg",
    price: 55,
    seller: "Ram Das",
    colors: [
      Colors.black,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/women_sweater.jpeg",
    price: 120,
    seller: "Joy Store",
    colors: [
      Colors.brown,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/men_jacket.jpeg",
    price: 155,
    seller: "Jacket Store",
    colors: [
      Colors.blueAccent,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/air_jordan.jpeg",
    price: 255,
    seller: "The Seller",
    colors: [
      Colors.grey,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/super_perfume.jpeg",
    price: 155,
    seller: "Love Seller",
    colors: [
      Colors.purpleAccent,
  ...
  Product(
    ...
    description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Donec massa sapien faucibus et molestie ac feugiat. In massa tempor nec feugiat nisl. Libero id faucibus nisl tincidunt.",
    image: "assets/images/wedding_ring.jpeg",
    price: 155,
    seller: "I Am Seller",
    colors: [
      Colors.brown,
